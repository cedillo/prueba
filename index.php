<?php
	...
	try{
		...
		$db = new PDO('sqlsrv:Server='. [$hostname] . ';dbname='. [$database] . ';charset=utf8',[$username], [$password] );
	}catch (PDOException $e) {
		print "ERROR: " . $e->getMessage() . "<br><br>HOSTNAME: " . $hostname . " BD:" . $database . " UDI: " . $username . " PASS: " . $password . "<br><br>";
		die();
	}
